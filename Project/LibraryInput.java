/*
Program :- Write a Java Program To Print Library input
...
class Library
{
 ...
 void display()
 {
     System.out.println("Book Name : "+this.bookName+" "+" Author Name : "+this.bookAuthor+" "+" Price of Book : "+this.bookPrice);
  }
